...
import { tripData, fetchReviews, fallbackReviews, fetchImages, fetchItinerary, fallbackItinerary, ReviewsResponse, ImagesResponse, ItineraryResponse } from "@/components/trip-data-es"
